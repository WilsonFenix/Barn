...
@section('body')
<!-- Background image -->
<div class="row pt-5 ps-8" style="background-image:{{asset('img/fundo_forms.jpg')}};">
    <!-- Background image -->
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Tarefas Planejadas
                            </div>
    ...
    <div class="conteiner ">
        <div class="row ps-5 px-5">
            ...
            <div class="conteiner  mb-3 col-6 p-5 ">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="small font-weight-bold">
                            projeto <span class="float-right">20%</span>
                        </h4>
                        ...
                        <h4 class="small font-weight-bold">projeto n<span class="float-right">Complete!</span></h4>
                        <div class="progress">
                ...
                <div class="card shadow mb-4 ">
                    <table class="table">
                        <div class="fs-4 fw-bold text-center ">Lista dos melhores trabalhadores</div>
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                ...
                <div class="card shadow mb-5">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="row text-center pb-3">
                            <form>
                                <h5>Subscreva para o nosso newsletter</h5>
                                <p>Seja nosso cliente e venha optmizar com a gente</p>
                                <div class="d-flex w-100 gap-2">
                                    <label for="newsletter1" class="visually-hidden">Email address</label>
                                    <input id="newsletter1" type="text" class="form-control"
                                        placeholder="Email address">
                                    <button class="btn btn-success" type="button">Subscreva</button>
                                </div>
                            </form>
                        </div>
                    </div>
