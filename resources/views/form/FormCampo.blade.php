                                    ...
                                    <form data-toggle="validator" role="form">
                                        <div class="form-group y-2">
                                            ...
                                            <input class="form-control" type="text" name="trabalhador_nome"
                                                placeholder="Digite o nome do campo..." required>
                                        </div>

                                        <div class="form-group">
                                            <label for="trabalhador_bi"></label>
                                            <input class="form-control" type="text" name="trabalhador_bi"
                                                placeholder="Digite o numero do lote..." required minlength="7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="trabalhador_n_contrato"
                                                placeholder="Digite o endereço do campo..." required minlength="7">
                                        </div>
                        ...
                        <div class=" align-content-center">
                            <form data-toggle="validator" role="form">
                                <div class="form-group y-2">
                                    <label for="trabalhador_nome"></label>
                                    <input class="form-control" type="text" name="trabalhador_nome"
                                        placeholder="Digite o lote da parcela..." required>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="trabalhador_bi"></label>
                                    <input class="form-control" type="text" name="trabalhador_n_contrato"
                                        placeholder="Digite a cultura..." required minlength="7">
