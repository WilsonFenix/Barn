                      ...
                      <form data-toggle="validator" role="form">
                        <div class="form-group y-2" >
                          <label for="trabalhador_nome"></label>
                            <input class="form-control" type="text" name="trabalhador_nome" placeholder="Digite o nome do trabalhador..." required>
                        </div>
  
                        <div class="form-group">
                          <label for="trabalhador_bi"></label>
                            <input class="form-control" type="text" name="trabalhador_bi" placeholder="Digite o numero do BI do trabalhador..." required minlength="7">
                            <span class="help-block">Mínimo de seis (6) digitos</span>
                        </div>
  
                        <div class="form-group">
                          <label for="trabalhador_bi"></label>
                            <input class="form-control" type="text" name="trabalhador_n_contrato" placeholder="Digite o numero do contrato do trabalhador..."required minlength="7">
                        </div>
